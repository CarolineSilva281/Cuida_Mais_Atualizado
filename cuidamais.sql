...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/08/2025 às 00:14
...
INSERT INTO `planos` (`id_plano`, `nome_plano`, `preco`, `descricao`) VALUES
(1, 'Plano Visibilidade', 199.00, 'Sua casa aparece em destaque no site com maior alcance'),
(2, 'Plano Apoio', 399.00, 'Além da visibilidade, receba voluntários da saúde');
...
INSERT INTO `solicitacoes` (`id_solicitacao`, `id_casa`, `nome_idoso`, `telefone`, `email`, `motivo`, `criado_em`) VALUES
(5, 7, 'Roberto Luiz', '(11)966858371', 'rafaelluiz@gmail.com', 'Meu pai, Roberto, de 86 anos, teve uma alta hospitalar recente após uma cirurgia no fêmur. Ele precisa de cuidados de enfermagem e fisioterapia que não conseguimos oferecer em casa. Buscamos um lugar para uma estadia temporária de reabilitação.', '2025-08-26 19:32:11'),
(6, 8, 'Helena de Brito', '(11)98858471', 'mariadebrito@gmail.com', 'Gostaria de solicitar informações sobre vagas para minha avó, Helena, de 88 anos. Ela foi diagnosticada com Alzheimer em estágio inicial e precisamos de um ambiente com supervisão 24 horas e atividades que estimulem a memória e a socialização.', '2025-08-26 19:38:29');
...
--
ALTER TABLE `solicitacoes`
  ADD CONSTRAINT `solicitacoes_ibfk_1` FOREIGN KEY (`id_casa`) REFERENCES `casas` (`id_casa`) ON DELETE CASCADE;
COMMIT;
